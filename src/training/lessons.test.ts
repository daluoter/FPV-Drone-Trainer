...
describe('phase 6 lesson catalog', () => {
  it('exposes exactly the approved unavailable curriculum with semantic geometry contracts', () => {
  ...
  it('keeps the Split-S request elevated and explicit without enabling an evaluator', () => {
